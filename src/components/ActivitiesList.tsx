...
export default function ActivitiesList({activities, dispatch} : ActivitiesListProps) {
  ...
  return (
    <>
      <h2 className="text-4xl font-bold text-center p-3 col-span-2 mb-5 xl:mb-0">Food and Activities</h2>
        { isEmpty ?
        ...
        activities.map(activity => (
          <>
            <div 
              key={activity.id}
              className="px-5 py-10 bg-slate-100 shadow-inner rounded-3xl border-collapse mb-7 xl:mb-0 flex justify-between items-center"
            >
              <div className="space-y-2 relative">
                ...
                <p className="font-bold text-2xl">{activity.name_activity}</p>
              </div>
